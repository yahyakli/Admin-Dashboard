...
var S = (0, import_react.memo)(function(t3) {
  ...
  return (0, import_jsx_runtime.jsxs)(animated.g, v({ transform: u.transform }, k2, { children: [(0, import_jsx_runtime.jsx)("line", { x1: 0, x2: o, y1: 0, y2: l, style: d.axis.ticks.line }), (0, import_jsx_runtime.jsx)(animated.text, { dominantBaseline: f, textAnchor: x, transform: u.textTransform, style: d.axis.ticks.text, children: m })] }));
});
var T = (0, import_react.memo)(function(e3) {
  ...
  if (void 0 !== z2) {
    ...
    "y" === n3 ? (Q2 = -90, L2 = R, "start" === C2 ? (K2 = "start", M = m) : "middle" === C2 ? (K2 = "middle", M = m / 2) : "end" === C2 && (K2 = "end")) : (M = R, "start" === C2 ? K2 = "start" : "middle" === C2 ? (K2 = "middle", L2 = m / 2) : "end" === C2 && (K2 = "end", L2 = m)), J2 = (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + L2 + ", " + M + ") rotate(" + Q2 + ")", textAnchor: K2, style: v({ dominantBaseline: "central" }, q.axis.legend.text), children: z2 });
  }
  var U = tt(), Z = U.animate, $2 = U.config, _2 = useSpring({ transform: "translate(" + x + "," + d + ")", lineX2: "x" === n3 ? m : 0, lineY2: "x" === n3 ? 0 : m, config: $2, immediate: !Z }), tt2 = useTransition(N, { keys: function(t3) {
    return t3.key;
  }, initial: function(t3) {
  ...
  return (0, import_jsx_runtime.jsxs)(animated.g, { transform: _2.transform, "aria-hidden": E, children: [tt2(function(e4, i2, n4, r2) {
...
var Y2 = (0, import_react.memo)(function(t3) {
  ...
  return (0, import_jsx_runtime.jsx)(animated.line, v({}, e3, i2.grid.line));
});
var W2 = (0, import_react.memo)(function(t3) {
  var e3 = t3.lines, i2 = tt(), r2 = i2.animate, a2 = i2.config, l = useTransition(e3, { keys: function(t4) {
    return t4.key;
  }, initial: function(t4) {
...
//# sourceMappingURL=chunk-2YO4IT3Y.js.map
